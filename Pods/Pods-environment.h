...
// RFKeychain
#define COCOAPODS_POD_AVAILABLE_RFKeychain
#define COCOAPODS_VERSION_MAJOR_RFKeychain 0
#define COCOAPODS_VERSION_MINOR_RFKeychain 1
#define COCOAPODS_VERSION_PATCH_RFKeychain 0
